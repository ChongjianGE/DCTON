...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str,
                            default='/apdcephfs/share_1330111/chongjiange/train_output/cycletryon/checkpoints/', help='models are saved here')
        # model parameter
        parser.add_argument('--model', type=str, default='viton_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='viton', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
